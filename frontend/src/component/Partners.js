...
const Partners = () => {
    return (
        <div>
            ...
            <div className="container pt-10 pb-10 mb-20 md:px-6 shadow-2xl  text-lg top-shadow-lg mx-auto bg-slate-50" style={{ "maxWidth": "90%" }}>
                {/* <!-- Section: Design Block --> */}
                <section className="mb-20 text-center">
                    <div className="flex justify-center">
                        <div className="max-w-[700px] text-center">
                            <h2 className="mb-6 text-center text-3xl font-bold text-orange-600">
                                Why is it so <u className="text-black dark:text-primary-400">
                                    great?</u>
                            </h2>
                    ...
                    <div className="grid gap-x-6 md:grid-cols-2 lg:grid-cols-4 lg:gap-x-12">
                        <div className="mb-12 lg:mb-0">
                            <div className="bg-slate-200 mb-6 inline-block rounded-full bg-primary-100 p-4 text-primary shadow-sm">
            ...
            <div className="bg-white py-24 sm:py-32">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <h2 className="text-center text-3xl pb-10 font-semibold leading-8 text-orange-600">Trusted by the world’s most innovative teams</h2>
